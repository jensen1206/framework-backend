...
export default class FirstTitle extends React.Component {
    constructor(props) {
        super(props);
        this.props = props;
        this.state = {
                    ...
                    <CardBody>
                        <Row className="g-2">
                            <Col xs={12}>
                                <FloatingLabel
                                    controlId={uuidv4()}
                                    label={`${trans['carousel']['First Title']}`}
                                >
                                    <Form.Control
                                        required={false}
                                        value={this.props.s.first_caption}
                                        onChange={(e) => this.props.onSetSlider(e.currentTarget.value, 'first_caption', this.props.s.id)}
                                        className="no-blur"
                                        as="textarea"
                                        style={{height: '100px'}}
                                        placeholder={trans['carousel']['First Title']}/>
                                </FloatingLabel>
                            ...
                            <Col xs={12}>
                                ...
                                <FloatingLabel
                                    ...
                                    <Form.Select
                                        ...
                                        value={this.props.s.first_ani}
                                        onChange={(e) => this.onSetAnimation(e.currentTarget.value, 'first_ani', this.props.s.id)}
                            ...
                            <Col xs={12}>
                                ...
                                >
                                    <Form.Control
                                        required={false}
                                        value={this.props.s.first_css || ''}
                                        onChange={(e) => this.props.onSetSlider(e.currentTarget.value, 'first_css', this.props.s.id)}
                                        className="no-blur"
                                        type="text"
                            ...
                            <Col xs={12}>
                                ...
                                >
                                    <Form.Control
                                        required={false}
                                        value={this.props.s.first_id || ''}
                                        onChange={(e) => this.props.onSetSlider(e.currentTarget.value, 'first_id', this.props.s.id)}
                                        className="no-blur"
                                        type="text"
