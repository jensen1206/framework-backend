...
export default class PluginTinyMce extends React.Component {
    constructor(props) {
        super(props);
        this.editor
        this.props = props;
    ...
    handleEditorChange(value, editor) {
        this.setState({value});
        this.props.editorCallbackContent(value)
            ...
            <React.Fragment>
                <Editor
                    ...
                    init={{
                        ...
                        toolbar1: `undo redo | blocks  fontsize | link bold italic forecolor  alignleft aligncenter alignright alignjustify|bullist numlist outdent indent  codesample removeformat code help|fullscreen`,
                        quickbars_selection_toolbar: `bold italic | forecolor backcolor link| alignleft aligncenter 
