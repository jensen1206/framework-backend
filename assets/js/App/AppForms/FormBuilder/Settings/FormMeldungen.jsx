...
export default class FormMeldungen extends React.Component {
    constructor(props) {
        super(props);
        this.props = props;
        this.state = {};
                                        ...
                                        {m.type === 'upload' ? (
                                            <>
                                                <div
                                                    ...
                                                    <h6 className="mb-2">{trans['forms']['Uploader messages']}</h6>
                                                    <Row className="g-2">
