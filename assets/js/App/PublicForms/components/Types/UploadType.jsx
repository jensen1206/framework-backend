...
export default class UploadType extends React.Component {
    constructor(props) {
        super(props);
        this.props = props;
        this.dropZoneContainer = React.createRef();
        this.dropZoneTemplate = React.createRef();
        this.dropZoneMessage = React.createRef();
    ...
    componentDidMount() {
        dropzoneUpload(this.onDropzoneCallback, this.props.form, this.dropZoneContainer.current.id, this.dropZoneTemplate.current.id, this.props.random)
    }
